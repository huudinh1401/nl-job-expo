...
import { SafeAreaView, Text, View, StatusBar, TouchableOpacity, Platform } from 'react-native';
import HeaderAdmin from './headerAdmin';
import JobMayTinh from './JobWorking/jobMayTinh';
import JobPhoTo from './JobWorking/jobPhoto';
import JobCongTrinh from './JobWorking/jobCongTrinh';
        ...
        <View style={{ flex: 1, backgroundColor: '#1e293b' }}>
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 9, marginTop: isAndroid15 ? 25 : 0 }}>
                    <View style={{ height: 45, zIndex: 9, paddingHorizontal: 8, paddingTop: 8 }}>
                    ...
                    <View style={{ marginTop: 16, paddingHorizontal: 8, flex: 1 }}>
                        <View style={{ flexDirection: 'row', height: 48, width: '100%', backgroundColor: '#334155', borderRadius: 12, padding: 4 }}>
                            <TouchableOpacity
                                style={{
                                    ...
                                    backgroundColor: jobMayTinh ? '#3b82f6' : 'transparent', borderRadius: 8, marginHorizontal: 2
                                }}
                            ...
                            <TouchableOpacity
                                style={{
                                    flex: 1, height: 40, justifyContent: 'center', alignItems: 'center',
                                    backgroundColor: jobPhoTo ? '#3b82f6' : 'transparent', borderRadius: 8, marginHorizontal: 2
                                }}
                                onPress={() => handlePhoto()}
                            >
                            ...
                            <TouchableOpacity
                                style={{
                                    flex: 1, height: 40, justifyContent: 'center', alignItems: 'center',
                                    backgroundColor: jobCongTrinh ? '#3b82f6' : 'transparent', borderRadius: 8, marginHorizontal: 2
                                }}
                        ...
                        <View style={{ flex: 1, marginTop: 8, backgroundColor: '#334155', borderRadius: 16, paddingVertical: 10, paddingHorizontal: 8 }}>
                            {
                                jobMayTinh ?
                                    <JobMayTinh /> : jobPhoTo ? <JobPhoTo /> : <JobCongTrinh />
                            }
                        </View>
                    </View>
                </View>
                {/* <View style={{ flex: 0.00000005 }} /> */}
            </SafeAreaView>
        </View>
    );
}
