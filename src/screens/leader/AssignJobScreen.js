...
import { Text, View, Platform, Image, Alert, StatusBar, TouchableOpacity, TextInput, Keyboard, TouchableWithoutFeedback, Modal, ScrollView, Dimensions } from 'react-native';
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, marginTop: isAndroid15 ? 35 : 0 }}>
                        <View style={{ height: 50, zIndex: 199, marginHorizontal: 5, backgroundColor: '#1e3a8a', borderRadius: 12, justifyContent: 'space-between', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3, flexDirection: 'row', paddingHorizontal: 15 }}>
                            ...
                            <TouchableOpacity onPress={() => setShowMenuModal(true)} style={{ backgroundColor: '#10b981', padding: 8, borderRadius: 18, elevation: 4, borderWidth: 2, borderColor: '#fff', shadowColor: '#10b981', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 }}>
                                <Ionicons name="menu" size={20} color="#fff" />
                            </TouchableOpacity>
                        </View>

                        <ScrollView style={{ flex: 1, paddingHorizontal: 10, paddingTop: 10 }} showsVerticalScrollIndicator={false}>
                            <TouchableOpacity style={{ height: 50, paddingHorizontal: 18, backgroundColor: '#ff6b35', alignItems: 'center', justifyContent: 'center', borderRadius: 15, position: 'absolute', top: 15, right: 20, zIndex: 8, elevation: 8, borderWidth: 2, borderColor: '#fff' }} onPress={() => handleDiemDanh()} activeOpacity={0.8}>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <MaterialIcons name="camera" size={22} color="white" style={{ marginRight: 8 }} />
                                    <Text style={{ color: 'white', fontSize: 14, fontWeight: '800' }}>CHẤM CÔNG</Text>
                                </View>
                            </TouchableOpacity>
