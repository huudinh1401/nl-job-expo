    ...
    return (
        <View style={{flex: 1, backgroundColor: '#1e293b', paddingTop: insets.top}}>
            ...
            <View style={{height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, backgroundColor: '#059669'}}>
                ...
                <TouchableOpacity onPress={() => setShowMenuModal(true)} style={{backgroundColor: 'rgba(255,255,255,0.15)', padding: 8, borderRadius: 20, elevation: 2, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)'}}>
            ...
            >
                ...
                <View style={{paddingHorizontal: 20}}>
                    {/* Nút điểm danh */}
                    <TouchableOpacity
                        style={{height: 50, paddingHorizontal: 18, backgroundColor: '#ff6b35', alignItems: 'center', justifyContent: 'center', borderRadius: 15, position: 'absolute', top: 15, right: 20, zIndex: 8, elevation: 8, borderWidth: 2, borderColor: '#fff'}}
                        onPress={handleDiemDanh}
                    >
                        <View style={{flexDirection: 'row', alignItems: 'center', backgroundColor: 'transparent'}}>
                            <Ionicons name='camera' size={22} color='white' style={{marginRight: 8}} />
