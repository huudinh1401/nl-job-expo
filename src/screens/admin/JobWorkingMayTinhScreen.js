            ...
            <View style={{ flex: 1, padding: 4 }}>
                {dataJobWorkingMayTinh.length > 0 ? (
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Ionicons name="desktop-outline" size={60} color="#6b7280" />
                        <Text style={{ color: '#9ca3af', fontSize: 16, fontWeight: '600', marginTop: 15, textAlign: 'center' }}>Không có công việc máy tính</Text>
